# Pointillism v0.8 — autonomous A3 test (2026-04-29T02:41:00.281Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v0.8).
...
Average over three scenes: 18094 ms (18.1 s).

## v0.8 algorithm changes (vs prior)
