# Pointillism v0.3 — autonomous A3 test (2026-04-29T01:08:40.111Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v0.3).
...
Average over three scenes: 15762 ms (15.8 s).

## v0.3 algorithm changes (vs prior)
