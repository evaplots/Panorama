# Pointillism v1.1-faithful — autonomous A3 test (2026-04-29T05:12:13.982Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.1-faithful).
...
Average over three scenes: 43921 ms (43.9 s).

## v1.1-faithful algorithm changes (vs prior)
