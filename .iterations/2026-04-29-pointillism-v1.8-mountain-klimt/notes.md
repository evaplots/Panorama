# Pointillism v1.8-mountain-klimt — autonomous A3 test (2026-04-29T09:40:49.370Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.8-mountain-klimt).
...
Average over three scenes: 21300 ms (21.3 s).

## v1.8-mountain-klimt algorithm changes (vs prior)
