# Pointillism v0.7 — autonomous A3 test (2026-04-29T02:12:19.689Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v0.7).
...
Average over three scenes: 28302 ms (28.3 s).

## v0.7 algorithm changes (vs prior)
