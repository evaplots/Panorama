# Pointillism v1.12-matrix-desert — autonomous A3 test (2026-04-29T15:49:30.663Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.12-matrix-desert).
...
Average over three scenes: 22476 ms (22.5 s).

## v1.12-matrix-desert algorithm changes (vs prior)
