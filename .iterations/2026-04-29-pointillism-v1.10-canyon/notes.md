# Pointillism v1.10-canyon — autonomous A3 test (2026-04-29T11:09:02.162Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.10-canyon).
...
Average over three scenes: 23103 ms (23.1 s).

## v1.10-canyon algorithm changes (vs prior)
