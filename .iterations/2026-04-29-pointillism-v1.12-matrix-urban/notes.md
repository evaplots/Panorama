# Pointillism v1.12-matrix-urban — autonomous A3 test (2026-04-29T15:21:11.464Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.12-matrix-urban).
...
Average over three scenes: 23648 ms (23.6 s).

## v1.12-matrix-urban algorithm changes (vs prior)
