# Pointillism v1.2-fast-median — autonomous A3 test (2026-04-29T05:17:59.722Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.2-fast-median).
...
Average over three scenes: 28374 ms (28.4 s).

## v1.2-fast-median algorithm changes (vs prior)
