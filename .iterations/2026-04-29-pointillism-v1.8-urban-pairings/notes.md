# Pointillism v1.8-urban-pairings — autonomous A3 test (2026-04-29T09:39:43.145Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.8-urban-pairings).
...
Average over three scenes: 24269 ms (24.3 s).

## v1.8-urban-pairings algorithm changes (vs prior)
