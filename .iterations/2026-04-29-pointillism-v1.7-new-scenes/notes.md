# Pointillism v1.7-new-scenes — autonomous A3 test (2026-04-29T09:09:34.647Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.7-new-scenes).
...
Average over three scenes: 21627 ms (21.6 s).

## v1.7-new-scenes algorithm changes (vs prior)
