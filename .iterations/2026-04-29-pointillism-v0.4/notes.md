# Pointillism v0.4 — autonomous A3 test (2026-04-29T01:11:05.825Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v0.4).
...
Average over three scenes: 19790 ms (19.8 s).

## v0.4 algorithm changes (vs prior)
