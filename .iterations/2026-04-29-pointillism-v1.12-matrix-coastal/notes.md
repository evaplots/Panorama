# Pointillism v1.12-matrix-coastal — autonomous A3 test (2026-04-29T15:41:59.088Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.12-matrix-coastal).
...
Average over three scenes: 23339 ms (23.3 s).

## v1.12-matrix-coastal algorithm changes (vs prior)
