# Pointillism v1.12-matrix-canyon — autonomous A3 test (2026-04-29T15:56:48.145Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.12-matrix-canyon).
...
Average over three scenes: 22946 ms (22.9 s).

## v1.12-matrix-canyon algorithm changes (vs prior)
