# Pointillism v1.12-matrix-snow — autonomous A3 test (2026-04-29T15:52:55.106Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.12-matrix-snow).
...
Average over three scenes: 20174 ms (20.2 s).

## v1.12-matrix-snow algorithm changes (vs prior)
