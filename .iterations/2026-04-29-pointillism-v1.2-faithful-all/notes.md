# Pointillism v1.2-faithful-all — autonomous A3 test (2026-04-29T05:21:02.480Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.2-faithful-all).
...
Average over three scenes: 26388 ms (26.4 s).

## v1.2-faithful-all algorithm changes (vs prior)
