# Pointillism v1.3-expressionist-comp — autonomous A3 test (2026-04-29T05:43:06.495Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.3-expressionist-comp).
...
**BORDERLINE — under 60s but slow enough that a progress UI is mandatory.**

Average over three scenes: 39635 ms (39.6 s).

## v1.3-expressionist-comp algorithm changes (vs prior)
