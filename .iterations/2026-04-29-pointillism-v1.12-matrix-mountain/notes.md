# Pointillism v1.12-matrix-mountain — autonomous A3 test (2026-04-29T15:17:12.131Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.12-matrix-mountain).
...
Average over three scenes: 21694 ms (21.7 s).

## v1.12-matrix-mountain algorithm changes (vs prior)
