# Pointillism v1.0-impasto-all — autonomous A3 test (2026-04-29T04:57:01.255Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.0-impasto-all).
...
Average over three scenes: 15573 ms (15.6 s).

## v1.0-impasto-all algorithm changes (vs prior)
