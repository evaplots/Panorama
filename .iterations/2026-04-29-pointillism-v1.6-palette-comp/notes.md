# Pointillism v1.6-palette-comp — autonomous A3 test (2026-04-29T08:42:47.839Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.6-palette-comp).
...
Average over three scenes: 24724 ms (24.7 s).

## v1.6-palette-comp algorithm changes (vs prior)
