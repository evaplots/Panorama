# Pointillism v1.12-matrix-storm — autonomous A3 test (2026-04-29T15:13:01.204Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.12-matrix-storm).
...
Average over three scenes: 22607 ms (22.6 s).

## v1.12-matrix-storm algorithm changes (vs prior)
