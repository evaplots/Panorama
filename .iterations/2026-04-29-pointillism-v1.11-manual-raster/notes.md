# Pointillism v1.11-manual-raster — autonomous A3 test (2026-04-29T11:39:45.802Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.11-manual-raster).
...
Average over three scenes: 14565 ms (14.6 s).

## v1.11-manual-raster algorithm changes (vs prior)
