# Pointillism v0.5 — autonomous A3 test (2026-04-29T01:24:56.765Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v0.5).
...
Average over three scenes: 30965 ms (31.0 s).

## v0.5 algorithm changes (vs prior)
