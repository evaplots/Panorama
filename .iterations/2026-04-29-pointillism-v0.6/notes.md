# Pointillism v0.6 — autonomous A3 test (2026-04-29T02:00:33.918Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v0.6).
...
Average over three scenes: 19729 ms (19.7 s).

## v0.6 algorithm changes (vs prior)
