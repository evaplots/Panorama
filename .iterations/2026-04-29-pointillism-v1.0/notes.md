# Pointillism v1.0 — autonomous A3 test (2026-04-29T04:59:46.267Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.0).
...
Average over three scenes: 14724 ms (14.7 s).

## v1.0 algorithm changes (vs prior)
