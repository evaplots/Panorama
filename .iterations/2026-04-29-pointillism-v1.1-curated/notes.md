# Pointillism v1.1-curated — autonomous A3 test (2026-04-29T05:13:24.291Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.1-curated).
...
Average over three scenes: 21782 ms (21.8 s).

## v1.1-curated algorithm changes (vs prior)
