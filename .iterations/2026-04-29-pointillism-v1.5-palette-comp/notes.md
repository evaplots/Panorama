# Pointillism v1.5-palette-comp — autonomous A3 test (2026-04-29T08:11:21.500Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.5-palette-comp).
...
Average over three scenes: 24481 ms (24.5 s).

## v1.5-palette-comp algorithm changes (vs prior)
