# Pointillism v0.9-dense — autonomous A3 test (2026-04-29T03:11:01.608Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v0.9-dense).
...
Average over three scenes: 33499 ms (33.5 s).

## v0.9-dense algorithm changes (vs prior)
