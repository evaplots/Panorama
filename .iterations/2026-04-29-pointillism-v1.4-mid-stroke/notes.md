# Pointillism v1.4-mid-stroke — autonomous A3 test (2026-04-29T07:11:28.623Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.4-mid-stroke).
...
Average over three scenes: 22744 ms (22.7 s).

## v1.4-mid-stroke algorithm changes (vs prior)
