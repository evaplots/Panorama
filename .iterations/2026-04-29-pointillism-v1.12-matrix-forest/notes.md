# Pointillism v1.12-matrix-forest — autonomous A3 test (2026-04-29T15:45:41.643Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.12-matrix-forest).
...
Average over three scenes: 21781 ms (21.8 s).

## v1.12-matrix-forest algorithm changes (vs prior)
