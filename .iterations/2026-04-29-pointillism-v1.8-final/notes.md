# Pointillism v1.8-final — autonomous A3 test (2026-04-29T09:45:06.768Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.8-final).
...
Average over three scenes: 26415 ms (26.4 s).

## v1.8-final algorithm changes (vs prior)
