# Pointillism v1.8-7scene-expressionist — autonomous A3 test (2026-04-29T09:48:37.800Z)

## What this is

Headless A3 @ 300 DPI test of `src/style/Pointillism.js` (v1.8-7scene-expressionist).
...
Average over three scenes: 22781 ms (22.8 s).

## v1.8-7scene-expressionist algorithm changes (vs prior)
